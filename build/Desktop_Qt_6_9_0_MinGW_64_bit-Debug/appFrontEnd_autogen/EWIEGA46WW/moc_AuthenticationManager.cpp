...
namespace {
struct qt_meta_tag_ZN21AuthenticationManagerE_t {};
} // unnamed namespace

template <> constexpr inline auto AuthenticationManager::qt_create_metaobjectdata<qt_meta_tag_ZN21AuthenticationManagerE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<AuthenticationManager, qt_meta_tag_ZN21AuthenticationManagerE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject AuthenticationManager::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN21AuthenticationManagerE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN21AuthenticationManagerE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN21AuthenticationManagerE_t>.metaTypes,
    nullptr
} };
...
void AuthenticationManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AuthenticationManager::*)()>(_a, &AuthenticationManager::loginSuccess, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (AuthenticationManager::*)(const QString & )>(_a, &AuthenticationManager::loginFailed, 1))
            return;
    }
}
...
void *AuthenticationManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN21AuthenticationManagerE_t>.strings))
