        ...
        Column {
            ...
            Row {
                ...
                Component.onCompleted: {
                       rosConnector.sendMessage('{"op": "subscribe", "topic": "/hoverboard/connected", "type": "std_msgs/Bool"}');
                       rosConnector.sendMessage('{"op": "subscribe", "topic": "/hoverboard/battery_voltage", "type": "std_msgs/Float64"}');
                   }
